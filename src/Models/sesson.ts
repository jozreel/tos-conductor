...
class Session extends BaseModel{
    ...
    public constructor(session_id: string, _token: string, userid: string, createddate: Date, lastmoddate: Date, createdby: string = 'SYSTEM', lastmodifiedby:string='SYSTEM') {
